...
function manual_deposit_transactions_list_shortcode() {
    ...
    $transactions = $wpdb->get_results("SELECT mpesa_name, amount_in_ksh, status FROM $table_name ORDER BY id DESC");
